...
#سلام و درود
#من الگوريتم اين سوال را پيدا کردم و کدي که در ادامه آمده کپي پيست از اينترنت است
#من خودم کلي تلاش کردم که  با پايگيم پياده سازي کنم ولي نتوانستم
...
def palette_reduce(img, nc):
    ...
    return Image.fromarray(carr)
image_proces = fs_dither(img , 2)
dim = fs_dither(img, 2)
dim.save('dimg-{}.jpg'.format(2))
